...
export default function ProjectPage() {
  ...
  const heroImage = project.image_url || "/images/JyotiVilla.jpg";
  const thumb1 = project.gallery_updates?.[0]?.media_url || project.image_url_dark || "/images/ShreeSadhna.jpg";
  const thumb2 = project.gallery_updates?.[1]?.media_url || project.image_url_light || "/images/JyotiVillaNight.jpg";

  return (
    <div>
      <div className="bg-background border-b border-border">
        <div className="max-w-7xl mx-auto px-6 py-4">
          <Link href="/" className="text-xs font-bold uppercase tracking-widest text-muted-foreground hover:text-accent transition-colors">
            ← Back to Projects
          </Link>
        </div>
      </div>
