                ...
                <div className="p-7 pt-9 space-y-4">
                  ...
                  <LField label="Full Name" error={errors.name}>
                    <input type="text" placeholder="Alex Johnson" value={name}
                      ...
                      style={iStyle("name")}
                      onFocus={e => e.currentTarget.style.borderColor = "hsl(12 50% 38%)"}
                      onBlur={e => e.currentTarget.style.borderColor = errors.name ? "hsl(0 50% 45%)" : "rgba(255,255,255,0.1)"} />
                  </LField>
                  ...
                  <LField label="Email Address" error={errors.email}>
                    <input type="email" placeholder="alex@studio.com" value={email}
                      ...
                      style={iStyle("email")}
                      onFocus={e => e.currentTarget.style.borderColor = "hsl(12 50% 38%)"}
                      onBlur={e => e.currentTarget.style.borderColor = errors.email ? "hsl(0 50% 45%)" : "rgba(255,255,255,0.1)"} />
                  </LField>
...
function LField({ label, error, children }: { label: string; error?: string; children: React.ReactNode }) {
  return (
    <div>
      <label className="block text-xs font-medium mb-1.5" style={{ color: "hsl(12 8% 46%)" }}>{label}</label>
      {children}
      {error && (
